...
def get_parser(parser=None, required=True):
    ...
    # CHANGE
    parser.add_argument('--report-interval-epochs', default=1, type=int,
                        help="Report interval epochs")
...
def main(cmd_args):
    ...
    if args.dist_train:
        ...
        distributed.init_process_group(backend=distributed.Backend.NCCL)
    ...
    if args.dist_train and args.local_rank != 0:
       logging.warning(f'Set logging of node {args.local_rank} to CRITICAL level.')
